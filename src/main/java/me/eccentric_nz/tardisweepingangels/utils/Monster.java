...
public enum Monster {
    ...
    SEA_DEVIL("Sea Devil", EntityType.DROWNED, "devil", 19, 5, Material.KELP, TARDISWeepingAngels.DEVIL),
    ...
    SLITHEEN("Slitheen", EntityType.ZOMBIE, "slitheen", 20, 5, Material.TURTLE_EGG, TARDISWeepingAngels.SLITHEEN),
